<!DOCTYPE html>
        ...
        <head>
            ...
            <title> O Túmulo do Batman-Coleção Completa </title>
        </head>
        ...
        <body>
            ...
            <main>
                ...
                <h2> O Túmulo do Batman-Coleção Completa </h2>
                <div id='partes'>
                    <div class='esquerda'>
                        <div class='imagemPrincipal'>
                            <img src='../fotos/2-144-0-2023_01_22__18_10_28.jpg' alt='Imagem 1 do anuncio'>
                    ...
                    <div id='infos'>
                        ...
                        <p> Coleção completa.Dois volumes em ótimos estados,lidos apenas uma vez e guardados em sacos plásticos para conservação em minha coleção pessoal. </p>
            ...
            <div class='modal'>
                <div class='modalContent'>
                    <form action='../php/tenhoInteresse.php' method='post'>
                        ...
                        <input type='hidden' name='codAnuncio' value='144'>
