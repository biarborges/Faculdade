<!DOCTYPE html>
        ...
        <head>
            ...
            <title> Acordeon Ballone Burini 120 Baixos </title>
        </head>
        ...
        <body>
            ...
            <main>
                ...
                <h2> Acordeon Ballone Burini 120 Baixos </h2>
                <div id='partes'>
                    <div class='esquerda'>
                        <div class='imagemPrincipal'>
                            <img src='../fotos/1-145-0-2023_01_22__18_20_50.jpg' alt='Imagem 1 do anuncio'>
                            <img src='../fotos/1-145-1-2023_01_22__18_20_50.jpg' alt='Imagem 2 do anuncio'>
                            <img src='../fotos/1-145-2-2023_01_22__18_20_50.jpg' alt='Imagem 3 do anuncio'>
                            <img src='../fotos/1-145-3-2023_01_22__18_20_50.jpg' alt='Imagem 4 do anuncio'>
                        </div>
                    ...
                    <div id='infos'>
                        <p class='preco'>R$ 28000 </p>
                        <div id='compra'>
                            <button id='interesse'>Tenho interesse</button>
                        </div>
                        <p> Tipo de acordeon: Piano

Marca: Ballone Burini
...
Quantidade de baixos: 120

Quantidade de chaves: 46

Agendamento prévio para testar o instrumento.
Valor à vista! </p>
            ...
            <div class='modal'>
                <div class='modalContent'>
                    <form action='../php/tenhoInteresse.php' method='post'>
                        ...
                        <input type='hidden' name='codAnuncio' value='145'>
