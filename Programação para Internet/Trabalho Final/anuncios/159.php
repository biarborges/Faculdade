<!DOCTYPE html>
        ...
        <head>
            ...
            <title> Controle TV Philco </title>
        </head>
        ...
        <body>
            ...
            <main>
                ...
                <h2> Controle TV Philco </h2>
                <div id='partes'>
                    <div class='esquerda'>
                        <div class='imagemPrincipal'>
                            <img src='../fotos/12-159-0-2023_01_22__19_45_08.jpg' alt='Imagem 1 do anuncio'>
                    ...
                    <div id='infos'>
                        ...
                        <p> Controle Tv Philco Lcd/ Led,UNI-1049 / Rc3000m01. </p>
            ...
            <div class='modal'>
                <div class='modalContent'>
                    <form action='../php/tenhoInteresse.php' method='post'>
                        ...
                        <input type='hidden' name='codAnuncio' value='159'>
