                ...
                <div id='partes'>
                    <div class='esquerda'>
                        <div class='imagemPrincipal'>
                            <img src='../fotos/10-157-0-2023_01_22__19_38_09.jpg' alt='Imagem 1 do anuncio'>
                            <img src='../fotos/10-157-1-2023_01_22__19_38_09.jpg' alt='Imagem 2 do anuncio'>
                    ...
                    <div id='infos'>
                        <p class='preco'>R$ 280 </p>
                        <div id='compra'>
                            <button id='interesse'>Tenho interesse</button>
                        </div>
                        <p> 
Vendo ou troco por Zelda breath of the wild </p>
            ...
            <div class='modal'>
                <div class='modalContent'>
                    <form action='../php/tenhoInteresse.php' method='post'>
                        ...
                        <input type='hidden' name='codAnuncio' value='157'>
