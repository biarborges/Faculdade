<!DOCTYPE html>
        ...
        <head>
            ...
            <title> Contra Baixo Tagíma TBM5 (Mostruário) </title>
        </head>
        ...
        <body>
            ...
            <main>
                ...
                <h2> Contra Baixo Tagíma TBM5 (Mostruário) </h2>
                <div id='partes'>
                    <div class='esquerda'>
                        <div class='imagemPrincipal'>
                            <img src='../fotos/2-143-0-2023_01_22__17_52_14.jpg' alt='Imagem 1 do anuncio'>
                            <img src='../fotos/2-143-1-2023_01_22__17_52_14.jpg' alt='Imagem 2 do anuncio'>
                            <img src='../fotos/2-143-2-2023_01_22__17_52_14.jpg' alt='Imagem 3 do anuncio'>
                            <img src='../fotos/2-143-3-2023_01_22__17_52_14.jpg' alt='Imagem 4 do anuncio'>
                        </div>
                    ...
                    <div id='infos'>
                        <p class='preco'>R$ 1390 </p>
                        <div id='compra'>
                            <button id='interesse'>Tenho interesse</button>
                        </div>
                        <p> Somos a M&Gê Music Shop a melhor loja de instrumentos musicais em Diadema Av Fábio Eduardo Ramos Esquivel 119 </p>
            ...
            <div class='modal'>
                <div class='modalContent'>
                    <form action='../php/tenhoInteresse.php' method='post'>
                        ...
                        <input type='hidden' name='codAnuncio' value='143'>
