<!DOCTYPE html>
        ...
        <head>
            ...
            <title> asdfghjklç~cvghbnjkmlç </title>
        </head>
        ...
        <body>
            ...
            <main>
                ...
                <h2> asdfghjklç~cvghbnjkmlç </h2>
                <div id='partes'>
                    <div class='esquerda'>
                        <div class='imagemPrincipal'>
                            <img src='../fotos/3-165-0-2023_01_22__20_17_30.jpg' alt='Imagem 1 do anuncio'>
                    ...
                    <div id='infos'>
                        <p class='preco'>R$ 0.02 </p>
                        <div id='compra'>
                            <button id='interesse'>Tenho interesse</button>
                        </div>
                        <p> idkhfjidshfdsjhfkdsjhdsjkdhsfk </p>
            ...
            <div class='modal'>
                <div class='modalContent'>
                    <form action='../php/tenhoInteresse.php' method='post'>
                        ...
                        <input type='hidden' name='codAnuncio' value='165'>
