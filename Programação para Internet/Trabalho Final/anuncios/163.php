<!DOCTYPE html>
        ...
        <body>
            ...
            <main>
                ...
                <h2> GTX 1050 TI 4GB </h2>
                <div id='partes'>
                    <div class='esquerda'>
                        <div class='imagemPrincipal'>
                            <img src='../fotos/13-163-0-2023_01_22__19_55_07.jpg' alt='Imagem 1 do anuncio'>
                    ...
                    <div id='infos'>
                        ...
                        <p> 
PLACA DE VIDEO SEMINOVA, FUNCIONANDO PERFEITAMENTE </p>
            ...
            <div class='modal'>
                <div class='modalContent'>
                    <form action='../php/tenhoInteresse.php' method='post'>
                        ...
                        <input type='hidden' name='codAnuncio' value='163'>
